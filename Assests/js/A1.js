jQuery(document).ready(function() {
	...
	jQuery(window).load(function() {
		...
		// btn join up
		jQuery(".join-us").on("click", function() {
			jQuery(".coming-soon .coming-soon-content").fadeOut("medium", function() {
				jQuery("#hide-content").fadeIn(600, function() {
					jQuery(".arrow-up").animate({
						bottom: "-40px"
...
$(document).scroll(function() {
	var y = $(this).scrollTop();
	if (y > 1000) {
		$(".chatpopup-widget").fadeIn();
	} else {
		$(".chatpopup-widget").fadeOut();
	}
});
$(document).scroll(function() {
	var y = $(this).scrollTop();
...
$(document).ready(function() {
	$("#drop-down-arc").click(function() {
		$(this).find("#drop-down-T").slideToggle("slow");
	});
});
$(document).ready(function() {
	$("#drop-down-int").click(function() {
		$(this).find("#drop-down-T").slideToggle("slow");
	});
});
$(document).ready(function() {
	$("#drop-down-pro").click(function() {
		$(this).find("#drop-down-T").slideToggle("slow");
	});
});
$(document).ready(function() {
	$(".drop-down-banner").click(function() {
		$(this).find(".drop-down-text").slideToggle("slow");
	});
});
$num = $('.ui-card').length;
$even = $num / 2;
...
//   hide about in galalery //
$(document).scroll(function() {
	var y = $(this).scrollTop();
	if (y > 500) {
		$("aside-toggle").fadeIn();
	} else {
		$("aside-toggle").fadeOut();
	}
});
//   live chat //
...
$(".send-wa").on('click', function(event) {
	event.preventDefault();
	sendMessage();
});
...
function sendMessage() {
	var number = "966551224755";
	var message = $("input[name=message_to_send]").val();
	if (message == undefined || message == "") {
		message = "Hi," + " " + "and I need more information About...".replace(" ", "%20");
	} else {
...
//----------------------- Search Bar ----------------------------------//
function hatchSearch() {
	// Declare variables
	var input, filter, ul, li, a, i;
	input = document.getElementById("searchInput");
	filter = input.value.toUpperCase();
	ul = document.getElementById("hatch-list");
